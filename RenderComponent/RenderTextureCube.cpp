...
void RenderTexture::ClearRenderTarget(ID3D12GraphicsCommandList* commandList, int slice, bool clearColor, bool clearDepth)
{
...
D3D12_CPU_DESCRIPTOR_HANDLE RenderTexture::GetColorDescriptor(CubeMapFace face)
{
	return rtvHeap.hCPU((int)face);
}
D3D12_CPU_DESCRIPTOR_HANDLE RenderTexture::GetDepthDescriptor(CubeMapFace face)
{
